...
[_LOWER] = LAYOUT(
  ...
  _______, KC_F12,  _______, _______, _______, KC_CAPS,                   KC_TILD, KC_EQL, KC_UNDS, KC_LCBR, KC_RCBR,  _______,
  _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______,
  _______, _______, _______, _______, _______, KC_BSLS, _______, _______, KC_PIPE, KC_MINS, KC_PLUS, KC_LBRC, KC_RBRC, _______,
                             _______, _______, _______, _______, _______, _______, _______, _______
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
